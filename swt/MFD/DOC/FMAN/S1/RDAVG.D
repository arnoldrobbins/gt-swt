          ...
          |      'Rdavg'  is  part of the toy relational data base management
          |      system, 'rdb'.  It computes the average value of a specified
          |      attribute over all rows of the  relation  that  satisfy  the
          |      optional  select  expression.   If  no  select expression is
          |      given then it computes the average of an attribute over  all
          |      rows  of the relation.  Standard input 1 must be directed to
          |      a file containing an 'rdb' relation.  The result is  written
          |      to standard output.
          ...
          |      rdcount (1), rddiff (1), rddiv (1), rdint  (1),  rdmax  (1),
