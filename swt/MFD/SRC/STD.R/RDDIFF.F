      ...
      INTEGER I,J,LASTI,COPYIT,S,SAMER0
...
10007 CALL SAVERD(RD1,-11)
      IF((ISATTY(-11).NE.1))GOTO 10009
        CALL PRINT0(RD1,-11)
10009 M=MARKF(-12)
10010 IF((GETROW(RD1,-10,ROW1).EQ.-1))GOTO 10011
        COPYIT=1
        CALL SEEKF(M,-12)
10012   IF(((GETROW(RD2,-12,ROW2).EQ.-1).OR.(COPYIT.NE.1)))GOTO 10013
          SAMER0=1
          I=3+1
          J=3+1
          GOTO 10016
...
10016     IF((I.GT.RD1(2)))GOTO 10015
          IF((J.GT.RD2(2)))GOTO 10015
            ...
            IF((COMPA0(RD1(I),BUF1,BUF2).EQ.2))GOTO 10017
              SAMER0=0
10017     GOTO 10014
10015     IF((SAMER0.NE.1))GOTO 10018
            COPYIT=0
10018   GOTO 10012
10013   IF((COPYIT.NE.1))GOTO 10019
          CALL PUTROW(RD1,-11,ROW1)
10019 GOTO 10010
10011 IF((ISATTY(-11).NE.1))GOTO 10020
        CALL PRINU0(RD1,-11)
10020 CALL SWT
      END
      ...
      IF((ISATTY(FD).NE.1))GOTO 10021
        CALL REMARK('Sorry, a relation can''t be read from the terminal.
     *')
        LOADRD=-3
        RETURN
10021 IF((READF(RD(1),1,FD).NE.-1))GOTO 10022
        LOADRD=-3
        RETURN
10022 IF((READF(RD(2),RD(1)-1,FD).NE.-1))GOTO 10023
...
10023 LOADRD=-2
      ...
      INTEGER FD
      INTEGER ISATTY
      IF((ISATTY(FD).NE.1))GOTO 10024
        CALL PRINV0(RD,FD)
        GOTO 10025
10024   CALL WRITEF(RD,RD(1),FD)
10025 RETURN
      END
     ...
     *2,160,170,177,182,243,160,252,170,238,0/
      ...
      GOTO 10028
10026 I=I+22
10028 IF((I.GT.RD(2)))GOTO 10027
        AAAAD0=RD(I)
        GOTO 10029
10030     CALL CTOC(AAAAE0,TYPE,102)
        GOTO 10031
10032     CALL CTOC(AAAAF0,TYPE,102)
        GOTO 10031
10033     CALL CTOC(AAAAG0,TYPE,102)
        GOTO 10031
10029   GOTO(10030,10032,10033),AAAAD0
10031   CALL PRINT(FD,AAAAH0,TYPE,RD(I+1),RD(I+5))
      GOTO 10026
10027 CALL PRINT(FD,AAAAI0)
      RETURN
      END
...
10039   RD(I+1)=LEN
      ...
      GOTO 10037
10035 GOTO(10036,10038,10039),AAAAJ0
...
10043 IF((I.GT.RD(2)))GOTO 10042
        IF((EQUAL(RD(I+5),NAME).NE.1))GOTO 10044
          FINDF0=I
          RETURN
10044 GOTO 10041
10042 FINDF0=0
     ...
     *233,170,238,0/
      AAAAK0=TYPE
      GOTO 10045
10046   R=COMPB0(BUF1,BUF2)
      GOTO 10047
10048   R=COMPC0(BUF1,BUF2)
      GOTO 10047
10049   R=COMPD0(BUF1,BUF2)
      GOTO 10047
10045 GOTO(10046,10048,10049),AAAAK0
...
10047 COMPA0=R
      ...
      INTEGER * 4 I1,I2
      IF((I1.GE.I2))GOTO 10050
        COMPB0=1
        RETURN
10050 IF((I1.LE.I2))GOTO 10051
        COMPB0=3
        RETURN
10051 COMPB0=2
      RETURN
      ...
      REAL * 8 D1,D2
      IF((D1.GE.D2))GOTO 10052
        COMPC0=1
        RETURN
10052 IF((D1.LE.D2))GOTO 10053
        COMPC0=3
        RETURN
10053 COMPC0=2
      RETURN
      ...
      GOTO 10056
10054 I=I+(1)
10056 IF((S1(I).NE.S2(I)))GOTO 10055
      IF((S1(I).EQ.0))GOTO 10055
      GOTO 10054
10055 IF((S1(I).NE.S2(I)))GOTO 10057
        COMPD0=2
        RETURN
10057 IF((S1(I).EQ.0))GOTO 10059
      IF((S1(I).LT.S2(I)))GOTO 10059
      GOTO 10058
10059   COMPD0=1
        RETURN
10058 COMPD0=3
...
10062 IF((I.GT.RD(2)))GOTO 10061
      ...
      GOTO 10060
10061 CALL PRINT(FD,AAAAO0)
      CALL PRINT(FD,AAAAP0)
      I=3+1
      GOTO 10065
10063 I=I+22
10065 IF((I.GT.RD(2)))GOTO 10064
        CALL PRINT(FD,AAAAQ0,RD(I+4),RD(I+5))
      GOTO 10063
10064 CALL PRINT(FD,AAAAR0)
...
10067 CALL PRINT(FD,AAAAU0)
      ...
      GOTO 10071
10069 I=I+22
10071 IF((I.GT.RD(2)))GOTO 10070
        CALL PRINT(FD,AAAAW0,RD(I+4)+3)
      GOTO 10069
10070 CALL PRINT(FD,AAAAX0)
      RETURN
      END
...
10074 IF((I.GT.RD(2)))GOTO 10073
        AAAAZ0=RD(I)
        GOTO 10075
10076     CALL PRINT(FD,AAABA0,RD(I+4),BUF(RD(I+2)))
        GOTO 10077
10078     CALL PRINT(FD,AAABB0,RD(I+4),BUF(RD(I+2)))
        GOTO 10077
10079     CALL PRINT(FD,AAABC0,RD(I+4),RD(I+1),BUF(RD(I+2)))
        GOTO 10077
10075   GOTO(10076,10078,10079),AAAAZ0
10077 GOTO 10072
10073 CALL PRINT(FD,AAABD0)
      RETURN
      END
      ...
      INTEGER BUF(500)
      INTEGER ISATTY
      IF((ISATTY(FD).NE.1))GOTO 10080
        CALL PRINW0(RD,FD,BUF)
        GOTO 10081
10080   CALL WRITEF(BUF,RD(3),FD)
10081 RETURN
      END
...
10087   J=J-(1)
        K=K-(1)
10089   IF((K.LE.0))GOTO 10088
        IF((BUF(J).NE.160))GOTO 10088
        GOTO 10087
10088   DEST(K+1)=0
        GOTO 10092
10090   J=J-(1)
        K=K-(1)
10092   IF((K.LE.0))GOTO 10091
          DEST(K)=BUF(J)
        GOTO 10090
10091 GOTO 10084
10082 GOTO(10083,10085,10086),AAABE0
10084 RETURN
      END
...
10098   J=J+(1)
        K=K+(1)
10100   IF((SRC(K).EQ.0))GOTO 10099
        IF((K.GT.RD(I+1)))GOTO 10099
          BUF(J)=SRC(K)
        GOTO 10098
10099   GOTO 10103
10101   K=K+(1)
        J=J+(1)
10103   IF((K.GT.RD(I+1)))GOTO 10102
          BUF(J)=160
        GOTO 10101
10102 GOTO 10095
10093 GOTO(10094,10096,10097),AAABF0
10095 RETURN
      END
