     ...
     *6,245,229,243,170,238,0/
      DATA AAAAB0/193,246,229,242,225,231,229,160,233,243,160,245,238,22
     *8,229,230,233,238,229,228,160,230,239,242,160,229,237,240,244,249,
     *160,242,229,236,225,244,233,239,238,170,238,0/
      IF((LOADRD(RD,-10).EQ.-2))GOTO 10000
        CALL ERROR('Cannot load input relation.')
10000 IF((GETARG(3,ARG,128).EQ.-1))GOTO 10001
        CALL ERROR('Usage: rdavg [<selection expr>] <attr>.')
...
10002   IF((GETARG(1,SUMMA0,128).EQ.-1))GOTO 10004
          FLAG=1
          GOTO 10005
10004     CALL ERROR('Usage: rdavg [<selection expr>] <attr>.')
10005 CONTINUE
