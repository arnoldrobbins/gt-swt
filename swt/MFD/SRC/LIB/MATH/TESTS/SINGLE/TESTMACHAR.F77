...
C
  ...
  110 FORMAT ('Value of eps (see text): ',E30.16/)
  120 FORMAT ('Value of epsneg (see text): ',E30.16/)
  130 FORMAT ('Value of xmin (see text): ',E30.16/)
  140 FORMAT ('Value of xmax (see text): ',E30.16/)
      END
