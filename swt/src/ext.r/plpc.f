      ...
      INTEGER AAAAG0(3)
      INTEGER AAAAH0(3)
      DATA CTAB/1,0,0,228,229,226,245,231,0,2,0,1,229,242,242,244,0,3,0,
     *0,229,248,240,0,4,0,0,238,239,229,242,242,244,0,5,0,0,239,230,230,
     *243,229,244,0,6,0,0,243,233,236,0,7,0,0,248,242,229,230,0/
      DATA CPOS/7,1,10,18,25,35,45,52/
      DATA ITAB/5,0,1,1,-106,-106,-106,-100,0,-101,4,-102,2,-104,-100,1,
     *-101,2,-102,4,-104,-105,6,0,1,0,-106,-106,-106,-100,0,-102,5,-104,
     *-100,1,-101,5,-104,-105,17,0,1,1,-106,-106,-106,-100,0,-101,6,-104
     *,-100,1,-102,6,-104,-105,22,1,2,1,-106,-106,-106,-100,1,-102,3,-10
     *4,-100,2,-101,3,-104,-105,24,0,1,1,-106,-106,-106,-100,0,-102,7,-1
     *04,-100,1,-101,7,-104,-105/
      DATA IPOS/5,1,23,41,59,77/
      DATA NLOFG0/3,5,7,0/
      DATA NLOFF0/1,1/
      DATA NLONT0/0/
      DATA NLONP0/1,1/
      DATA AAAAA0/229,188,239,233,190,230,188,239,233,190,241,188,239,23
     *3,190,246,188,239,233,190,248,188,239,233,190,226,188,239,243,190,
     *236,188,239,243,190,250,188,239,243,190,0/
      DATA AAAAB0/0/
      DATA AAAAC0/175,228,229,246,175,238,245,236,236,0/
      DATA AAAAD0/0/
      DATA AAAAE0/174,240,236,240,0/
      DATA AAAAF0/174,236,0/
      DATA AAAAG0/174,226,0/
      DATA AAAAH0/238,239,0/
      IF((PARSCL(AAAAA0,A$BUF).EQ.-2))GOTO 10000
        CALL REMARK('Usage: plpc {-<opt>[<level>]} <file> {-(b|l) [<file
     *>]} [-z <string>].')
        CALL ERROR('       <opt> -> e|f|q|v|x.')
...
10008 CALL PRINT(-11,'plp -i *s -b *s -l *s.',INPF,BINF,LISTF)
      I=1
      GOTO 10011
10009 I=I+(1)
