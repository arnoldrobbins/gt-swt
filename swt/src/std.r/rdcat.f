      ...
      INTEGER I,J
      INTEGER ROW(500)
      INTEGER LOADRD,EQUAL,ISATTY,GETROW
...
10007 CALL SAVERD(RD1,-11)
      IF((ISATTY(-11).NE.1))GOTO 10009
        CALL PRINT0(RD1,-11)
10009 CONTINUE
10010 IF((GETROW(RD1,-10,ROW).EQ.-1))GOTO 10011
        CALL PUTROW(RD1,-11,ROW)
      GOTO 10010
10011 CONTINUE
10012 IF((GETROW(RD2,-12,ROW).EQ.-1))GOTO 10013
        CALL PUTROW(RD2,-11,ROW)
      GOTO 10012
10013 IF((ISATTY(-11).NE.1))GOTO 10014
        CALL PRINU0(RD1,-11)
10014 CALL SWT
      END
      ...
      IF((ISATTY(FD).NE.1))GOTO 10015
        CALL REMARK('Sorry, a relation can''t be read from the terminal.
     *')
        LOADRD=-3
        RETURN
10015 IF((READF(RD(1),1,FD).NE.-1))GOTO 10016
        LOADRD=-3
        RETURN
10016 IF((READF(RD(2),RD(1)-1,FD).NE.-1))GOTO 10017
...
10017 LOADRD=-2
      ...
      INTEGER FD
      INTEGER ISATTY
      IF((ISATTY(FD).NE.1))GOTO 10018
        CALL PRINV0(RD,FD)
        GOTO 10019
10018   CALL WRITEF(RD,RD(1),FD)
10019 RETURN
      END
     ...
     *2,160,170,177,182,243,160,252,170,238,0/
      ...
      GOTO 10022
10020 I=I+22
10022 IF((I.GT.RD(2)))GOTO 10021
        AAAAD0=RD(I)
        GOTO 10023
10024     CALL CTOC(AAAAE0,TYPE,102)
        GOTO 10025
10026     CALL CTOC(AAAAF0,TYPE,102)
        GOTO 10025
10027     CALL CTOC(AAAAG0,TYPE,102)
        GOTO 10025
10023   GOTO(10024,10026,10027),AAAAD0
10025   CALL PRINT(FD,AAAAH0,TYPE,RD(I+1),RD(I+5))
      GOTO 10020
10021 CALL PRINT(FD,AAAAI0)
      RETURN
      END
...
10033   RD(I+1)=LEN
      ...
      GOTO 10031
10029 GOTO(10030,10032,10033),AAAAJ0
...
10034 ADDFI0=I
      ...
      GOTO 10037
10035 I=I+22
10037 IF((I.GT.RD(2)))GOTO 10036
        IF((EQUAL(RD(I+5),NAME).NE.1))GOTO 10038
          FINDF0=I
          RETURN
10038 GOTO 10035
10036 FINDF0=0
     ...
     *233,170,238,0/
      AAAAK0=TYPE
      GOTO 10039
10040   R=COMPB0(BUF1,BUF2)
      GOTO 10041
10042   R=COMPC0(BUF1,BUF2)
      GOTO 10041
10043   R=COMPD0(BUF1,BUF2)
      GOTO 10041
10039 GOTO(10040,10042,10043),AAAAK0
...
10041 COMPA0=R
      ...
      INTEGER * 4 I1,I2
      IF((I1.GE.I2))GOTO 10044
        COMPB0=1
        RETURN
10044 IF((I1.LE.I2))GOTO 10045
        COMPB0=3
        RETURN
10045 COMPB0=2
      RETURN
      ...
      REAL * 8 D1,D2
      IF((D1.GE.D2))GOTO 10046
        COMPC0=1
        RETURN
10046 IF((D1.LE.D2))GOTO 10047
        COMPC0=3
        RETURN
10047 COMPC0=2
      RETURN
      ...
      GOTO 10050
10048 I=I+(1)
10050 IF((S1(I).NE.S2(I)))GOTO 10049
      IF((S1(I).EQ.0))GOTO 10049
      GOTO 10048
10049 IF((S1(I).NE.S2(I)))GOTO 10051
        COMPD0=2
        RETURN
10051 IF((S1(I).EQ.0))GOTO 10053
      IF((S1(I).LT.S2(I)))GOTO 10053
      GOTO 10052
10053   COMPD0=1
        RETURN
10052 COMPD0=3
      ...
      GOTO 10056
10054 I=I+22
10056 IF((I.GT.RD(2)))GOTO 10055
        CALL PRINT(FD,AAAAN0,RD(I+4)+3)
      GOTO 10054
10055 CALL PRINT(FD,AAAAO0)
      CALL PRINT(FD,AAAAP0)
      I=3+1
      GOTO 10059
10057 I=I+22
10059 IF((I.GT.RD(2)))GOTO 10058
        CALL PRINT(FD,AAAAQ0,RD(I+4),RD(I+5))
      GOTO 10057
10058 CALL PRINT(FD,AAAAR0)
...
10068 IF((I.GT.RD(2)))GOTO 10067
        AAAAZ0=RD(I)
        GOTO 10069
10070     CALL PRINT(FD,AAABA0,RD(I+4),BUF(RD(I+2)))
        GOTO 10071
10072     CALL PRINT(FD,AAABB0,RD(I+4),BUF(RD(I+2)))
        GOTO 10071
10073     CALL PRINT(FD,AAABC0,RD(I+4),RD(I+1),BUF(RD(I+2)))
        GOTO 10071
10069   GOTO(10070,10072,10073),AAAAZ0
10071 GOTO 10066
10067 CALL PRINT(FD,AAABD0)
      RETURN
      END
      ...
      INTEGER BUF(500)
      INTEGER ISATTY
      IF((ISATTY(FD).NE.1))GOTO 10074
        CALL PRINW0(RD,FD,BUF)
        GOTO 10075
10074   CALL WRITEF(BUF,RD(3),FD)
10075 RETURN
      END
...
10081   J=J-(1)
        K=K-(1)
10083   IF((K.LE.0))GOTO 10082
        IF((BUF(J).NE.160))GOTO 10082
        GOTO 10081
10082   DEST(K+1)=0
        GOTO 10086
10084   J=J-(1)
        K=K-(1)
10086   IF((K.LE.0))GOTO 10085
          DEST(K)=BUF(J)
        GOTO 10084
10085 GOTO 10078
10076 GOTO(10077,10079,10080),AAABE0
10078 RETURN
      END
...
10092   J=J+(1)
        K=K+(1)
10094   IF((SRC(K).EQ.0))GOTO 10093
        IF((K.GT.RD(I+1)))GOTO 10093
          BUF(J)=SRC(K)
        GOTO 10092
10093   GOTO 10097
10095   K=K+(1)
        J=J+(1)
10097   IF((K.GT.RD(I+1)))GOTO 10096
          BUF(J)=160
        GOTO 10095
10096 GOTO 10089
10087 GOTO(10088,10090,10091),AAABF0
10089 RETURN
      END
