      ...
      INTEGER GETROW,CMPROW,LOADRD,ISATTY
      IF((LOADRD(RD,-10).EQ.-2))GOTO 10000
        CALL ERROR('Can''t access input relation.')
10000 CALL SAVERD(RD,-11)
      IF((ISATTY(-11).NE.1))GOTO 10001
        CALL PRINT0(RD,-11)
10001 T=GETROW(RD,-10,ROW1)
10002 IF((T.EQ.-1))GOTO 10003
        T=GETROW(RD,-10,ROW2)
        GOTO 10006
10004   T=GETROW(RD,-10,ROW2)
10006   IF((T.EQ.-1))GOTO 10005
        IF((CMPROW(RD,ROW1,ROW2).NE.1))GOTO 10005
        GOTO 10004
10005   CALL PUTROW(RD,-11,ROW1)
        IF((T.NE.-1))GOTO 10007
          GOTO 10003
10007   T=GETROW(RD,-10,ROW1)
        GOTO 10010
10008   T=GETROW(RD,-10,ROW1)
10010   IF((T.EQ.-1))GOTO 10009
        IF((CMPROW(RD,ROW1,ROW2).NE.1))GOTO 10009
        GOTO 10008
10009   CALL PUTROW(RD,-11,ROW2)
      GOTO 10002
10003 IF((ISATTY(-11).NE.1))GOTO 10011
        CALL PRINU0(RD,-11)
10011 CALL SWT
      END
      ...
      GOTO 10014
10012 I=I-(1)
10014 IF((I.LE.0))GOTO 10013
        IF((ROW1(I).EQ.ROW2(I)))GOTO 10015
          CMPROW=0
          RETURN
10015 GOTO 10012
10013 CMPROW=1
      ...
      IF((ISATTY(FD).NE.1))GOTO 10016
        CALL REMARK('Sorry, a relation can''t be read from the terminal.
     *')
        LOADRD=-3
        RETURN
10016 IF((READF(RD(1),1,FD).NE.-1))GOTO 10017
        LOADRD=-3
        RETURN
10017 IF((READF(RD(2),RD(1)-1,FD).NE.-1))GOTO 10018
...
10018 LOADRD=-2
      ...
      INTEGER FD
      INTEGER ISATTY
      IF((ISATTY(FD).NE.1))GOTO 10019
        CALL PRINV0(RD,FD)
        GOTO 10020
10019   CALL WRITEF(RD,RD(1),FD)
10020 RETURN
      END
     ...
     *2,160,170,177,182,243,160,252,170,238,0/
      ...
      GOTO 10023
10021 I=I+22
10023 IF((I.GT.RD(2)))GOTO 10022
        AAAAD0=RD(I)
        GOTO 10024
10025     CALL CTOC(AAAAE0,TYPE,102)
        GOTO 10026
10027     CALL CTOC(AAAAF0,TYPE,102)
        GOTO 10026
10028     CALL CTOC(AAAAG0,TYPE,102)
        GOTO 10026
10024   GOTO(10025,10027,10028),AAAAD0
10026   CALL PRINT(FD,AAAAH0,TYPE,RD(I+1),RD(I+5))
      GOTO 10021
10022 CALL PRINT(FD,AAAAI0)
      RETURN
      END
...
10034   RD(I+1)=LEN
      ...
      GOTO 10032
10030 GOTO(10031,10033,10034),AAAAJ0
...
10035 ADDFI0=I
      ...
      GOTO 10038
10036 I=I+22
10038 IF((I.GT.RD(2)))GOTO 10037
        IF((EQUAL(RD(I+5),NAME).NE.1))GOTO 10039
          FINDF0=I
          RETURN
10039 GOTO 10036
10037 FINDF0=0
     ...
     *233,170,238,0/
      AAAAK0=TYPE
      GOTO 10040
10041   R=COMPB0(BUF1,BUF2)
      GOTO 10042
10043   R=COMPC0(BUF1,BUF2)
      GOTO 10042
10044   R=COMPD0(BUF1,BUF2)
      GOTO 10042
10040 GOTO(10041,10043,10044),AAAAK0
...
10042 COMPA0=R
      ...
      INTEGER * 4 I1,I2
      IF((I1.GE.I2))GOTO 10045
        COMPB0=1
        RETURN
10045 IF((I1.LE.I2))GOTO 10046
        COMPB0=3
        RETURN
10046 COMPB0=2
      RETURN
      ...
      REAL * 8 D1,D2
      IF((D1.GE.D2))GOTO 10047
        COMPC0=1
        RETURN
10047 IF((D1.LE.D2))GOTO 10048
        COMPC0=3
        RETURN
10048 COMPC0=2
      RETURN
      ...
      GOTO 10051
10049 I=I+(1)
10051 IF((S1(I).NE.S2(I)))GOTO 10050
      IF((S1(I).EQ.0))GOTO 10050
      GOTO 10049
10050 IF((S1(I).NE.S2(I)))GOTO 10052
        COMPD0=2
        RETURN
10052 IF((S1(I).EQ.0))GOTO 10054
      IF((S1(I).LT.S2(I)))GOTO 10054
      GOTO 10053
10054   COMPD0=1
        RETURN
10053 COMPD0=3
...
10060 IF((I.GT.RD(2)))GOTO 10059
      ...
      GOTO 10058
10059 CALL PRINT(FD,AAAAR0)
      CALL PRINT(FD,AAAAS0)
      I=3+1
      GOTO 10063
10061 I=I+22
10063 IF((I.GT.RD(2)))GOTO 10062
        CALL PRINT(FD,AAAAT0,RD(I+4)+3)
      GOTO 10061
10062 CALL PRINT(FD,AAAAU0)
      RETURN
      END
      ...
      GOTO 10066
10064 I=I+22
10066 IF((I.GT.RD(2)))GOTO 10065
        CALL PRINT(FD,AAAAW0,RD(I+4)+3)
      GOTO 10064
10065 CALL PRINT(FD,AAAAX0)
      RETURN
      END
...
10069 IF((I.GT.RD(2)))GOTO 10068
        AAAAZ0=RD(I)
        GOTO 10070
10071     CALL PRINT(FD,AAABA0,RD(I+4),BUF(RD(I+2)))
        GOTO 10072
10073     CALL PRINT(FD,AAABB0,RD(I+4),BUF(RD(I+2)))
        GOTO 10072
10074     CALL PRINT(FD,AAABC0,RD(I+4),RD(I+1),BUF(RD(I+2)))
        GOTO 10072
10070   GOTO(10071,10073,10074),AAAAZ0
10072 GOTO 10067
10068 CALL PRINT(FD,AAABD0)
      RETURN
      END
      ...
      INTEGER BUF(500)
      INTEGER ISATTY
      IF((ISATTY(FD).NE.1))GOTO 10075
        CALL PRINW0(RD,FD,BUF)
        GOTO 10076
10075   CALL WRITEF(BUF,RD(3),FD)
10076 RETURN
      END
...
10085   J=J-(1)
        K=K-(1)
10087   IF((K.LE.0))GOTO 10086
          DEST(K)=BUF(J)
        GOTO 10085
10086 GOTO 10079
10077 GOTO(10078,10080,10081),AAABE0
10079 RETURN
      END
...
10093   J=J+(1)
        K=K+(1)
10095   IF((SRC(K).EQ.0))GOTO 10094
        IF((K.GT.RD(I+1)))GOTO 10094
          BUF(J)=SRC(K)
        GOTO 10093
10094   GOTO 10098
10096   K=K+(1)
        J=J+(1)
10098   IF((K.GT.RD(I+1)))GOTO 10097
          BUF(J)=160
        GOTO 10096
10097 GOTO 10090
10088 GOTO(10089,10091,10092),AAABF0
10090 RETURN
      END
